...
public class PemesanTiket extends SistemTiket{
    ...
    public void masukanJumlahTiket() {
        ...
        jumlahTiket = inputPemesan.nextInt();
    }
    ...
    public void printNota() {
        ...
        Pemesanan pemesananSementara = new  Pemesanan(namaPemesan, getTahapPembelian(), getTiket(), jumlahTiket);
        pemesananSementara.cetakNota();
    }
